...
The random-note.tsx is the index route is the default child of the notes route, see config index. It's rendered in the outlet on the route. It's using a loader to fetch a random note. Throws a 404 if no note is found.
